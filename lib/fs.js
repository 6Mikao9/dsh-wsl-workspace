import { a as isAbsoluteLinuxPath, c as joinUnc, d as parseWslUnc, f as windowsToMntPath, l as mntToWindowsPath, n as defaultDistroSync, p as Schema } from "./wsl-DdNPGaPo.js";
...
var WslFileSystem = class WslFileSystem extends LocalFileSystem {
	static Config = Schema.object({
		...
		diffBasisMaxBytes: Schema.number().default(10 * 1024 * 1024)
	});
	distro;
