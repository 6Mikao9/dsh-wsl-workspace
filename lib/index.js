import { a as normalizeLinuxPath, o as parseWslUnc, r as joinUnc, t as isAbsoluteLinuxPath } from "./paths-CZSghVn3.js";
import { r as listDistros, t as defaultDistro } from "./wsl-BRuCpLE9.js";
...
function apply(ctx, config) {
	...
	if (shellEnv !== void 0) ctx.effect(() => shellEnv.register({
		...
		variables: { DSH_WSL_DISTRO: { description: "The WSL distribution of the calling session workspace, when the session cwd is a WSL UNC path." } },
		resolve(execution) {
