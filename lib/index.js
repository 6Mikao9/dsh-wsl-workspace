...
function wslWorldGroup(shellPath, fsPath, includeEditor, persistent, searchPath, jobsPath) {
	return [
		...
		...jobsPath === void 0 || persistent === void 0 ? [] : ["    - id: jobs-wsl", `      name: '${jobsPath.replace(/'/g, "''")}'`],
		...includeEditor ? [
...
function transformPresetForWsl(source, shellPath, fsPath, persistent, searchPath, jobsPath) {
	...
	result.push(wslWorldGroup(shellPath, fsPath, sawEditor, persistent, sawSearch ? searchPath : void 0, jobsPath));
	return result.join("\n").replace(/\n{3,}/g, "\n\n").replace(/\n+$/, "\n");
}
...
async function materializeVariants(agentPresets, dshHome, paths, persistentShell) {
