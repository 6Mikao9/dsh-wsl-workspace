import { a as isAbsoluteLinuxPath, c as joinUnc, d as parseWslUnc, f as uncToLinux, l as mntToWindowsPath, o as isValidWslUsername, r as listDistros, t as defaultDistro, u as normalizeLinuxPath } from "./wsl.js";
import { a as registerWindowsWorkspace, i as listWorkspaceKeys, n as getWindowsWorkspace, o as setWorkspaceUsername, r as getWorkspaceUsername, t as canonicalWslUnc } from "./wsl-credentials.js";
import { n as resolveLinuxSymlinks } from "./links.js";
...
* invoking apply().
*/
const COLLISION_ROWS = /* @__PURE__ */ new Set(["tool-cordis"]);
function disableRow(block) {
	return block.map((l) => {
...
async function materializeVariants(agentPresets, dshHome, paths, persistentShell) {
	...
	for (const preset of presets) {
		...
		const transformed = transformPresetForWsl(await agentPresets.read(preset.id), paths.shell, paths.fs, persistentShell ? {
