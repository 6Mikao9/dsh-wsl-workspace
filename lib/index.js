...
function wslWorldGroup(shellPath, fsPath, includeEditor, persistent) {
	return [
...
*/
function transformPresetForWsl(source, shellPath, fsPath, persistent) {
...
var WslSkillsProvider = class {
	...
	constructor(control, io = nodeSkillIo, now = Date.now, refreshMs = REFRESH_POLL_MS) {
	...
	*/
	watch(cacheKey, distro, scanRoot, signature) {
