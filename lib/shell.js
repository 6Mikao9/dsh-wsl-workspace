import { c as joinUnc, d as parseWslUnc, f as windowsToMntPath, n as defaultDistroSync, o as isValidWslUsername, p as Schema, s as isWindowsPathShaped } from "./wsl-DdNPGaPo.js";
import { r as getWorkspaceUsername } from "./wsl-credentials-BcLGOFZ2.js";
...
var WslShellExecutor = class WslShellExecutor extends ShellExecutor {
	...
	static Config = Schema.object({
		...
		wslPath: Schema.string().default("wsl.exe"),
		loginShell: Schema.boolean().default(true),
		timeoutMs: Schema.number().default(12e4),
		maxTimeoutMs: Schema.number().default(6e5),
		maxOutputBytes: Schema.number().default(64e3),
		maxSpillBytes: Schema.number().default(DEFAULT_MAX_SPILL_BYTES),
